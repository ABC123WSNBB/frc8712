...
function createParticlePlanet(count) {
  ...
  return makePointLayer({ positions, colors, sizes, phases, kinds, opacity: .82, scale: 680 });
}
...
function createSpiralGalaxy(count) {
  ...
  return makePointLayer({ positions, colors, sizes, phases, kinds, opacity: .2, scale: 310 });
}
